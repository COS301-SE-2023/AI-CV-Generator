...
class TemplateE {
  ...
  Uint8List templateE(CVData data, ColorSet colorSet) {
    ...
    pages[currentPage].graphics.drawLine(
      PdfPens.black,
      Offset(leftBox.left, leftBox.bottom-bodyHeadingFont.height/2+11),
      Offset(leftBox.right, leftBox.bottom-bodyHeadingFont.height/2+11)
    );
  ...
  PdfLayoutResult drawNameSurname(Size pageSize, Rect bounds, String data) {
    return addColorText(
      pageSize,
      PdfSolidBrush(PdfColor(colorSet.colA!.red,colorSet.colA!.green,colorSet.colA!.blue,colorSet.colA!.alpha)),
