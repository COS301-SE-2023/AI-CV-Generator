...
class _CreatePdfState extends State<CreatePdfStatefulWidget> {
  ...
  Future<void> templateA(PdfDocument document, PdfPage page, List<int> bytes,Size pageSize,PdfGrid grid) async {
    showDialog(
      context: context, 
      builder: (context) {
        Size screenSize = MediaQuery.of(context).size;
                      ...
                      children: [
                       Container(
                        ...
                        child:  TextField(controller: controller,onChanged: (value) {
                          ...
                          templateA(document, page, bytes, pageSize, grid);
                        }),
                       )
                      ],
                    ),
  ...
  PdfLayoutResult drawHeader(PdfPage page, Size pageSize, PdfGrid grid) {
    ...
    page.graphics.drawString(
        ...
        bounds: Rect.fromLTWH(25, 0, 400, 90),
